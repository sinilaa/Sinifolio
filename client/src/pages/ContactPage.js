        ...
        <div className="content container">
          ...
          <div className="contact_information">
            ...
            <div className="contact_social">
              <a href="https://github.com/sinilaa" target="_blank" className="contact_icon">
                <RiGithubFill />
              </a>
              <a href="https://www.linkedin.com/in/sini-laamanen-23a011164" target="_blank" className="contact_icon">
                <RiLinkedinFill />
              </a>
              <a href="https://www.facebook.com/sini.laamanen/" target="_blank" className="contact_icon">
                <RiFacebookFill />
              </a>
              <a href="https://www.instagram.com/sinielaamanen/" target="_blank" className="contact_icon">
                <RiInstagramFill />
              </a>
            </div>
          </div>
